	...
	<div class="dream-home-bann-main wow bounceInDown" data-wow-delay="0.3s">
		...
		<div class="container"><div class="col-md-3"></div>	
				<div class="contact-right wow bounceInUp" data-wow-delay="0.3s">
				 ...
				 style="border:2px solid white;background-color:rgba(203,194,180,1)"><br/>
	<form action="savelocation.php" method="post" enctype="multipart/form-data">
               <?php
		   	 	 if(isset($_REQUEST['x']))
                 {
				 if($_REQUEST['x']=="thanks")
                  echo"<center><h5 class='green'>Thanks for Adding</h5></center><br/>";
                 } ?>
					   ...
					   <p>Select city</p>
					  	  <select id="disabledSelect" required="" name="cityname"class="form-control" >
			...
			<center><input type="submit" class="btn btn-default" value="submit" name="lct"><br/><br/>
	</center>
