...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2019 at 09:40 PM
...
(76, 'a', 'a@a.com', 123, 'doon village', 'Kitchener', '200', 0),
(77, 'a', 'a@a.com', 123, 'Conestoga college door 3', 'Kitchener', 'door 3', 0),
(78, 'a', 'a@a.com', 123, 'fairway road', 'Waterloo', '200 old carriage', 0),
(79, 'a', 'a@a.com', 123, 'fairview mall', 'Kitchener', '200 old carriage', 0);
...
(1, 'Kitchener', '200 old carriage drive'),
(2, 'Kitchener', 'Belmont avenue west'),
(3, 'Waterloo', 'fairway road'),
(4, 'Waterloo', 'Gandhi chowk'),
(5, 'Waterloo', 'Roshan ground'),
(6, 'Cambridge', 'session chowk'),
(7, 'Waterloo', 'bus stand'),
(8, 'kitchener', 'Conestoga college door 3'),
(9, 'Kitchener', 'doon village'),
(10, 'cambridge', 'linden drive'),
(11, 'kitchener', 'fairview mall');
...
(42, 'a@a.com', 'doon village', '200', '29/11/19', '11:57:54pm', '::1', 'cod', 64, 'Order Book', 600, ',12'),
(43, 'a@a.com', 'Conestoga college door 3', 'door 3', '29/11/19', '11:59:42pm', '::1', 'Credit Card', 65, 'Order Book', 600, ',12');
...
(64, 'cod', 'COD', '', 0, 0, 0, 0, 0, 'a@a.com'),
(65, 'Credit Card', '', 'karan', 455466, 9, 2022, 456, 0, 'a@a.com');
...
--
ALTER TABLE `add-categories`
  MODIFY `c-id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `add-product`
--
ALTER TABLE `add-product`
  MODIFY `p-id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `address`
--
ALTER TABLE `address`
  MODIFY `sno` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
-- AUTO_INCREMENT for table `cancelorder`
--
ALTER TABLE `cancelorder`
  MODIFY `cid` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
...
--
ALTER TABLE `orderdetail`
  MODIFY `oid` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
